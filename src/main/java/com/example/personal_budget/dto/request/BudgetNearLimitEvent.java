...
public class BudgetNearLimitEvent extends NotificationEvent {

    private final String categoryName;

    private final BigDecimal exceededAmount;

    public BudgetNearLimitEvent(Long userId, String categoryName, BigDecimal exceededAmount) {
        super(userId);
    ...
    public NotificationEventType getType() {
        return NotificationEventType.BUDGET_NEAR_LIMIT;
    }
}
